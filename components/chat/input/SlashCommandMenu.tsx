    ...
    return (
        ...
        >
            <div 
                ...
                className="bg-[var(--theme-bg-primary)] border border-[var(--theme-border-secondary)] rounded-lg shadow-premium max-h-60 overflow-y-auto custom-scrollbar p-2"
            >
                <p className="text-xs text-[var(--theme-text-tertiary)] px-2 pb-1 font-semibold tracking-wider">
                    COMMANDS
                </p>
                <ul>
