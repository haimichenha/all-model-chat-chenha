...
export const AppModals: React.FC<AppModalsProps> = (props) => {
    const {
        ...
        onPersistentStoreImportSuccess, activeApiConfig, handleActiveApiConfigChange, refreshTrigger,
        ...
        <>
          ...
          {isSettingsModalOpen && (
            <SettingsModal
              ...
              activeApiConfig={activeApiConfig?.id || null}
              useCustomApiConfig={appSettings.useCustomApiConfig}
              setUseCustomApiConfig={(value) => {
                handleSaveSettings({
                  ...appSettings,
                  useCustomApiConfig: value
                });
              }}
              handleActiveApiConfigChange={(configId: string | null) => {
                // 找到对应的完整ApiConfig对象
                const config = configId ? 
                  appSettings.apiConfigs.find(c => c.id === configId) || null : 
                  null;
                handleActiveApiConfigChange(config);
              }}
