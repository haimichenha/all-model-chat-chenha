...
export const useChat = (appSettings: AppSettings, language: 'en' | 'zh') => {
    ...
    return {
        ...
        handleExportChatHistory: historyHandler.handleExportChatHistory,
        handleImportChatHistory: historyHandler.handleImportChatHistory,
        handleExportChatHistoryAsText: historyHandler.handleExportChatHistoryAsText,
        handleImportChatHistoryFromText: historyHandler.handleImportChatHistoryFromText,
        // from fileHandler
